...
public class CounterServiceImpl implements CounterService {
     ...
     */
    @Override
    public boolean like(String entityType, String entityId, long userId, Long authorId) {
        return toggle(entityType, entityId, userId, "like", CounterSchema.IDX_LIKE, true, authorId);
    }
     ...
     */
    @Override
    public boolean unlike(String entityType, String entityId, long userId, Long authorId) {
        return toggle(entityType, entityId, userId, "like", CounterSchema.IDX_LIKE, false, authorId);
    }
     ...
     */
    @Override
    public boolean fav(String entityType, String entityId, long userId, Long authorId) {
        return toggle(entityType, entityId, userId, "fav", CounterSchema.IDX_FAV, true, authorId);
    }
     ...
     */
    @Override
    public boolean unfav(String entityType, String entityId, long userId, Long authorId) {
        return toggle(entityType, entityId, userId, "fav", CounterSchema.IDX_FAV, false, authorId);
    }
     ...
     */
    private boolean toggle(String etype, String eid, long uid, String metric, int idx, boolean add, Long authorId) {
        ...
        if (ok) {
            int delta = add ? 1 : -1;
            // 产出计数事件，Kafka 消费侧异步聚合到实体/作者维度计数
            CounterEvent event = CounterEvent.of(etype, eid, metric, idx, uid, delta, authorId);
