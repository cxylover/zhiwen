...
public class JwtService {
    ...
    private final JwtEncoder jwtEncoder;//签发
    private final JwtDecoder jwtDecoder;//解码
    private final AuthProperties properties;//配置
    ...
    public TokenPair issueTokenPair(User user) {
        String refreshTokenId = UUID.randomUUID().toString();// 刷新令牌 ID
        Instant issuedAt = Instant.now(clock);// 签发时间
